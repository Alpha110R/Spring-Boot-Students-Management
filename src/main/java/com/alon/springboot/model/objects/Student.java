package com.alon.springboot.model.objects;

import com.alon.springboot.util.Dates;
...
public class Student implements Serializable {
    ...
    /**
     * CascadeType.PERSIST is used when you want changes to an entity to be cascaded to related entities during the persist operation, and CascadeType.
     * REMOVE is used when you want changes to an entity to be cascaded to related entities during the remove operation.
     */
